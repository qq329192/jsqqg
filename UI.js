...
var 瑞科验证配制参数 =
{
  ...
  "软件编码": "766861cbc51008fc",     //如何获取：后台-->软件管理-->软件列表-->添加软件-->软件编码
  ...
  "加密Key": "53fb83d2",             //如何获取：后台-->软件管理-->软件列表-->选择一个已添加的软件-->编辑-->通讯方式-->选择DES或者RC4-->加密Key
  "签名盐": "6302e6f1",              //如何获取：后台-->软件管理-->软件列表-->选择一个已添加的软件-->编辑-->通讯方式-->选择DES或者RC4-->签名盐
...
function 登录成功后跳转的主界面() {
  ...
  ui.qdjb.on("click", () => {engines.execScriptFile("/data/user/0/com.jsqqg/files/project/main2.js");
